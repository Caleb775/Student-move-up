Rails.application.routes.draw do
  ...
  get "export/students.xlsx", to: "export#students_xlsx", as: :export_students_xlsx
  get "export/notes.csv", to: "export#notes_csv", as: :export_notes_csv
  get "export/notes.xlsx", to: "export#notes_xlsx", as: :export_notes_xlsx
  get "export/analytics.xlsx", to: "export#analytics_report", as: :export_analytics_xlsx

  # Import routes
  get "import", to: "import#index", as: :import
  get "import/template/:type/:format", to: "import#download_template", as: :import_template
