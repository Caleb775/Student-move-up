class ExportController < ApplicationController
  ...
  def students_xlsx
    ...
    respond_to do |format|
      format.xlsx do
        ...
        response.headers["Content-Disposition"] = "attachment; filename=students_#{Date.current.strftime('%Y%m%d')}.xlsx"
        ...
        send_data package.to_stream.read, filename: "students_#{Date.current.strftime('%Y%m%d')}.xlsx"
      end
    end
  end
  ...
  def notes_xlsx
    ...
    respond_to do |format|
      format.xlsx do
        response.headers["Content-Type"] = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        response.headers["Content-Disposition"] = "attachment; filename=notes_#{Date.current.strftime('%Y%m%d')}.xlsx"
        ...
        send_data package.to_stream.read, filename: "notes_#{Date.current.strftime('%Y%m%d')}.xlsx"
      end
    end
  end
  ...
  def analytics_report
    ...
    respond_to do |format|
      format.xlsx do
        response.headers["Content-Type"] = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        response.headers["Content-Disposition"] = "attachment; filename=analytics_report_#{Date.current.strftime('%Y%m%d')}.xlsx"
        ...
        send_data package.to_stream.read, filename: "analytics_report_#{Date.current.strftime('%Y%m%d')}.xlsx"
      end
    end
  end
